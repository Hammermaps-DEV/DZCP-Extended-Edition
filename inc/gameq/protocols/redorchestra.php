...
class GameQ_Protocols_Redorchestra extends GameQ_Protocols_Gamespy
{
    ...
    */
    protected function process_dzcp_runtime()
    {
        ...
        $result->add('game_maptitle', string::decode($this->server_data_stream['maptitle']));
        ...
        */
        ...
        if(isset($this->server_data_stream['players']) && count($this->server_data_stream['players']) >= 1)
        {
            foreach($this->server_data_stream['players'] as $player)
            {
                ...
                $new_player['player_team'] = !array_key_exists('team', $player) ? '2' : convert::ToString($player['team']);
                $new_player['player_squad'] = '0';
                $new_player['player_kills'] = convert::ToString($player['frags']);
