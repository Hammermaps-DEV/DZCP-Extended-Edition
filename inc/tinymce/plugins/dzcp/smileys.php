...
<?php
    ...
    foreach($files as $file)
    {
      ...
      $constraints = getimagesize(basePath.'/inc/images/smileys/'.$file);
      $x = $constraints[0]+6;
      $y = $constraints[1]+15;
...
echo $tr1; ?><td><a href="javascript:insertEmotion('<?php echo $file; ?>')"><img src="../../../images/smileys/<?php echo $file; ?>" border="0" alt="" /></a></td><?php echo $tr2;
    }
