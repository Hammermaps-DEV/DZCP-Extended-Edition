...
final class phpmailer
{
     ...
     * @type string
     */
    public static $From               = "root@localhost";
     ...
     * @type string
     */
    public static $FromName           = "Root User";
     ...
     *  @type bool
     */
    public static $UseMSMailHeaders = false;
     ...
     *  @type string
     */
    public static $Helo        = "localhost.localdomain";
