...
else
{
    ...
    if(!empty($server) && $server && $server['game_online']) //Online
    {
        ...
        //Admin MSG
        if(($chkMe == 4 || permission('editserver')) && $server['game_use_mod'])
        {
        ...
        //Admin MSG
        if(($chkMe == 4 || permission('editserver')) && !$pic_found && !$flash_found)
        {
            ...
            if(($chkMe == 4 || permission('editserver')) && !$icon_basic_inp['found'])
            {
                $admin_msg = (empty($admin_msg) ? '<p>' : $admin_msg);
            ...
            if(!empty($server['game_mod']))
            {
                ...
                if(($chkMe == 4 || permission('editserver')) && !$icon_mod_inp['found'])
                {
                    $admin_msg = (empty($admin_msg) ? '<p>' : $admin_msg);
        ...
        if(isset($_GET['showID']) ? $_GET['showID'] == $get['id'] : false)
