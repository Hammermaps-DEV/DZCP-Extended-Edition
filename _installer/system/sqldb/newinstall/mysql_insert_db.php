...
function install_mysql_insert($db_infos)
{
	...
	`eml_pn_subj`, `eml_fabo_npost`, `eml_fabo_tedit`, `eml_fabo_pedit`, `eml_pn`, `memcache_host`, `memcache_port`, `k_vwz`, `double_post`, `forum_vote`, `gb_activ`, `urls_linked`,`db_version`) VALUES (NULL, 
	...
	'1', '".strtolower(mkpwd(3,false))."', 'Neuer Beitrag auf abonniertes Thema im [titel]', 'Thread auf abonniertes Thema im [titel] wurde editiert', 'Beitrag auf abonniertes Thema im [titel] wurde editiert', 'Neue PN auf [domain]', 
	...
	(NULL, 1, 'nav_misc', 1, '_gametiger_', '../gametiger/', 0, 1, 0, 0, 0, NULL),
	(NULL, 2, 'nav_misc', 1, '_galerie_', '../gallery/', 0, 1, 0, 0, 0, NULL),
	(NULL, 3, 'nav_misc', 1, '_kontakt_', '../contact/', 0, 1, 0, 0, 0, NULL),
	(NULL, 4, 'nav_misc', 1, '_joinus_', '../contact/?action=joinus', 0, 1, 0, 0, 0, NULL),
	(NULL, 5, 'nav_misc', 1, '_fightus_', '../contact/?action=fightus', 0, 1, 0, 0, 0, NULL),
	(NULL, 6, 'nav_misc', 1, '_linkus_', '../linkus/', 0, 1, 0, 0, 0, NULL),
	(NULL, 7, 'nav_misc', 1, '_stats_', '../stats/', 0, 1, 0, 0, 0, NULL),
	(NULL, 8, 'nav_misc', 1, '_impressum_', '../impressum/', 0, 1, 0, 0, 0, NULL),
