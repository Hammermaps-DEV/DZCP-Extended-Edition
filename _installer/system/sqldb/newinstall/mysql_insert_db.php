...
function install_mysql_insert($db_infos)
{
    ...
    VALUES (NULL,
    '".up($db_infos['clanname'])."', '1', '1', '0', '1', '1', '1', 'version1.5', '0', '1', '', '', 'arsch,Arsch,arschloch,Arschloch,hure,Hure', '".up($db_infos['seitentitel'])."', '0', '".$_SERVER['SERVER_NAME']."', 'Max Mustermann', '123456789',
