...
define('mysql_no_ndb', 'Der MySQL Server ist kein Cluster!<p>Die NDB Engine kann nur auf einem MySQL Cluster verwendet werden.<br /><br />Sehe <a href="http://www.mysql.de/products/cluster/" target="_blank">MySQL Cluster</a>');
