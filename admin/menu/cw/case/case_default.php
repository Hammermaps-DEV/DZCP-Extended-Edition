...
while($get = _fetch($qry))
{
    ...
    $edit = show("page/button_edit_single", array("id" => $get['id'], "action" => "admin=cw&amp;do=edit", "title" => _button_title_edit));
    $delete = show("page/button_delete_single", array("id" => $get['id'], "action" => "admin=cw&amp;do=delete", "title" => _button_title_del, "del" => _confirm_del_cw));
...
$show = show($dir."/clanwars", array("show" => $show_list, "navi" => nav($entrys,10,"?admin=cw". (isset($_GET['squad']) ? '&amp;squad='.$_GET['squad'] : '') )));