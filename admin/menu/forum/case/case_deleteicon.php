...
if(isset($_GET['kat'])&&($_GET['kat']=="mainkat"||$_GET['kat']=="subkat")&&!empty($_GET[id]))
{
    if($_GET['kat']=="mainkat")
    {
        ...
        header('Location: ?index=admin&amp;admin=forum&do=edit&id='.convert::ToInt($_GET['id']));
    ...
    elseif($_GET['kat']=="subkat")
    {
        ...
        header('Location: ?index=admin&amp;admin=forum&do=editsubkat&id='.convert::ToInt($_GET['id']));
    }
}
